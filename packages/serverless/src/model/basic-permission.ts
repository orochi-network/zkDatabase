...
import { ZKDATABASE_BASIC_PERMISSION_COLLECTION } from './abstract/database-engine';
import { ModelGeneral } from './general';
import { UserPermission } from '../common/permission';
import ModelCollection from './collection';

export type BasicPermissionSchema = {
  groupId: ObjectId;
  groupName: string;
  collection: string;
  createdBy: string;
...
export class ModelBasicPermission extends ModelGeneral {
  constructor(databaseName: string) {
    super(databaseName, ZKDATABASE_BASIC_PERMISSION_COLLECTION);
  }
...
export default ModelBasicPermission;
